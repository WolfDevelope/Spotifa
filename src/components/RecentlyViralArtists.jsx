...
const { recentlyViralArtists } = data;

const RecentlyViralArtists = () => {
  const [showAll, setShowAll] = useState(false);

  // Chọn mảng video cần render
  const artistsToShow = showAll ? recentlyViralArtists : recentlyViralArtists.slice(0, 6);

  return (
    <section className="mb-8" id="recentlyViralArtistsList">
      <h2 className="text-2xl font-bold mb-3">
        Recently Viral <span className="text-pink-400">Artists</span>
      </h2>
...
export default RecentlyViralArtists; 
